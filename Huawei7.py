...
#	else:redmi.append(mi)
	A = f'Mozilla/5.0 (Linux; Android 5.1.1; SM-J320G Build/LMY47V; wv)'
	B = f'{str(rc(aZ))}{str(rc(aZ))}{str(rc(aZ))}{str(rr(11,99))}{str(rc(aZ))}'
	C = f'{str(rr(30,57))} Build/{B}) AppleWebKit/537.36 (KHTML, like Gecko)'
	D = f' Version/4.0 Chrome/{str(rr(20,100))}.0.{str(rr(1111,9999))}.{str(rr(20,100))} Mobile Safari/537.36'
	E = f' UCBrowser/11.5.2.1188 (UCMini) Mobile'
	F = f'{A}{C}{D}{E}'
	if F in redmi:pass
	else:redmi.append(F)
...
def login():
	...
	try:
		...
		link = ('https://www.facebook.com/100018396913729/posts/1127920134497873/?substory_index=0&app=fbl')
